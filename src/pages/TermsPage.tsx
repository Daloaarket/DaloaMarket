      ...
      <div className="container-custom max-w-4xl">
        <div className="bg-white rounded-card shadow-card p-6 md:p-8">
          ...
          <div className="prose max-w-none text-grey-700">
            ...
            <p>
              La publication d'une annonce sur DaloaMarket nécessite 1 crédit. Les crédits sont vendus par packs (Starter, Regular, Pro) et peuvent être achetés via PayDunya (Orange Money, MTN Mobile Money). Chaque publication consomme 1 crédit. Les options de boost restent payantes à l'unité et sont également réglées via PayDunya.
            </p>
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>Tous les paiements sont traités via PayDunya.</li>
            </ul>

      ...
      <div className="min-h-screen bg-grey-50 py-12">
        <div className="container-custom max-w-4xl">
          <div className="bg-white rounded-card shadow-card p-8 text-center">
            ...
            <p className="text-grey-600 mb-6">
              Cette annonce n'est pas accessible. Elle a peut-être été supprimée, n'est pas encore publiée, ou vous n'avez pas les droits pour la consulter.
            </p>
            <Link to="/" className="btn-primary">
              Retour à l'accueil
            </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-card shadow-card p-6 mb-6">
              ...
              {user && listing && user.id === listing.seller.id && (listing.status === 'active' || listing.status === 'pending') && (
              ...
              {user && listing && user.id === listing.seller.id && listing.status === 'pending' && (

  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 backdrop-blur-sm">
      ...
      <div className="relative bg-white h-full w-full max-w-sm ml-auto shadow-2xl">
        {/* Header */}
        <div className="bg-gradient-to-r from-primary to-primary-600 px-4 py-4 flex items-center justify-between">
        ...
        <div className="px-4 py-6 space-y-6 overflow-y-auto h-full pb-20 bg-white">
          {/* User Section */}
          {user ? (
